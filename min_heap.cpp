...
template <typename T, size_t SIZE>
void MinHeap<T, SIZE>::print() const 
{
    inner_print(0);
...
template <typename T, size_t SIZE>
void MinHeap<T, SIZE>::inner_print(int index) const
{
...
template <typename T, size_t SIZE>
void MinHeap<T, SIZE>::insert(T&& data)
{
...
template <typename T, size_t SIZE>
void MinHeap<T, SIZE>::remove(int index)
{
...
template <typename T, size_t SIZE>
int MinHeap<T, SIZE>::parent(int index) const
{
    return (index - 2 + (index & 1))/2;
}

template <typename T, size_t SIZE>
int MinHeap<T, SIZE>::left(int index) const
{
    return 2*index + 1;
}

template <typename T, size_t SIZE>
int MinHeap<T, SIZE>::right(int index) const
{
    return 2*index + 2;
}
